...
print('RECOVERED_ALL:',RECOVERED_ALL)
print('recovered_all:',recovered_all)
time='2020-{}美国疫情数据'.format(DATE[-1])
...
POSITIVE_situation=(
    ...
    .set_global_opts(
        ...
        yaxis_opts=opts.AxisOpts(name="Cumulative Cases", type_="value", max_=20,min_=11),
    )
    .set_series_opts(
...
Death_situation=(
    ...
    .set_global_opts(
        ...
        xaxis_opts=opts.AxisOpts(type_="category", boundary_gap=False),
        yaxis_opts=opts.AxisOpts(name="Cumulative Deaths", type_="value", max_=13,min_=8),
    )
    .set_series_opts(
        ...
        markarea_opts=opts.MarkAreaOpts(
            ...
            data=[
                opts.MarkAreaItem(
                    name="New Deaths(ln人数)",
                    x=("2009/9/12-7:00", "2009/9/22-7:00"),
                    label_opts=opts.LabelOpts(is_show=False),
                    itemstyle_opts=opts.ItemStyleOpts(color="#DCA3A2", opacity=0.5),
                ),
                opts.MarkAreaItem(
                    name="Cumulative Deaths(ln人数)",
                    x=("2009/9/10-7:00", "2009/9/20-7:00"),
                    label_opts=opts.LabelOpts(is_show=False),
                    itemstyle_opts=opts.ItemStyleOpts(color="#A1A9AF", opacity=0.5),
                ),
...
Situation_line=(
    ...
    .set_global_opts(
        ...
        xaxis_opts=opts.AxisOpts(type_="category", boundary_gap=False),
        yaxis_opts=opts.AxisOpts(name="positive", type_="value", max_=18,min_=9),
    )
    .set_series_opts(
        markarea_opts=opts.MarkAreaOpts(
            is_silent=False,
