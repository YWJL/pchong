...
js_formatter = """function (params) {
        console.log(params);
        return '降水量  '  + (params.seriesData.length ? '：' + params.seriesData[0].data : '');
...
(
    ...
    .extend_axis(
        ...
        xaxis=opts.AxisOpts(
            type_="category",
            axistick_opts=opts.AxisTickOpts(is_align_with_label=True),      #刻度
    ...
    .add_yaxis(
        ...
        xaxis_index=1,
        color="#d14a61",
        y_axis=[3.9, 5.9, 11.1, 18.7, 48.3, 69.2, 231.6, 46.8, 55.4, 18.4, 10.3, 0.7],
