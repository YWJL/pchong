...
url = 'https://coronavirus.1point3acres.com/_next/static/chunks/c88d2033c7648f63303f7e082fc388cb59b9d36f.1db1a29d94895de1a5b5.js'
headers = {
...
write_list_to_json(data_relative_confirmed_json,'20200515-world-active-data.json','D:/Pchong/可视化/data/20200518-data/')
data_csv=pd.DataFrame(json.loads(open('20200515-world-active-data.json','r+').read()))
print(end_1[36][0])
...
data_csv.T
data_csv.to_csv('20200515-world-active-data.json.csv')
df=pd.read_csv('20200515-world-active-data.json.csv')
new_csv=df.T
new_csv.to_csv('20200515-world-active-data.json.csv')
...
write_list_to_json(data_relative_confirmed_json,'20200515-world-confirm-data.json','D:/Pchong/可视化/data/20200518-data/')
data_csv=pd.DataFrame(json.loads(open('20200515-world-confirm-data.json','r+').read()))
print(end_1[36][0])
...
data_csv=data_csv.loc[:,cols]
data_csv.T
data_csv.to_csv('20200515-world-confirm-data.json.csv')
df=pd.read_csv('20200515-world-confirm-data.json.csv')
new_csv=df.T
new_csv.to_csv('20200515-world-confirm-data.json.csv')
...
write_list_to_json(data_relative_confirmed_json,'20200515-world-cover-data.json','E:/python_code/world_cov19')
data_csv=pd.DataFrame(json.loads(open('20200515-world-cover-data.json','r+').read()))
print(end_1[36][0])
...
data_csv=data_csv.loc[:,cols]
data_csv.T
data_csv.to_csv('20200515-world-cover-data.json.csv')
df=pd.read_csv('20200515-world-cover-data.json.csv')
new_csv=df.T
new_csv.to_csv('20200515-world-cover-data.json.csv')
...
write_list_to_json(data_relative_confirmed_json,'20200515-world-death-data.json','E:/python_code/world_cov19')
data_csv=pd.DataFrame(json.loads(open('20200515-world-death-data.json','r+').read()))
print(end_1[36][0])
...
data_csv=data_csv.loc[:,cols]
data_csv.T
data_csv.to_csv('20200515-world-death-data.json.csv')
df=pd.read_csv('20200515-world-death-data.json.csv')
new_csv=df.T
new_csv.to_csv('20200515-world-death-data.json.csv')