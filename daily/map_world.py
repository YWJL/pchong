...
death_name='D:/Pchong/data_see/data_all/20200529-world-death-data.json.csv'
positive_name='D:/Pchong/data_see/data_all/20200529-world-confirm-data.json.csv'
recovered_name='D:/Pchong/data_see/data_all/20200529-world-cover-data.json.csv'
line_world_name='D:/Pchong/data_see/data_all/2020-05-26-World_comfirmed.csv'
    ...
    Map(init_opts=opts.InitOpts(width="1400px", height="800px"))
        ...
        tooltip_opts=opts.TooltipOpts(
            trigger="item",  formatter=JsCode("""
                function(a){
            var result =['Venezuela', '1325'], counter = 0;
                return result+':'+{c};
            }
                """)
        ),
