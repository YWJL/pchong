...
name = 'D:/Pchong/data_see/data/20200628-data/2020-06-27-1point3acres-GA.json.csv'
...
title_GA_num = "2020/{}Georgia感染增加数（设各县感染人数均为10万人。）".format(
...
(
    ...
    .render("D:/Pchong/data_see/html_all/GA-26200611.html")
)
(
    Map(init_opts=opts.InitOpts(width="1400px", height="800px"))
    .add_js_funcs("echarts.registerMap('HK', {});".format(Js_data))
    ...
    .render("D:/Pchong/data_see/html_all/GA-100000.html")
)
...
map_ga = (
    ...
    .set_global_opts(
        title_opts=opts.TitleOpts(
            title=title_GA_num,
            subtitle="近七天感染人数增长比:{}   近五天:{}  近三天:{}  在这种情况下，若各县近3天实际确诊人数增长比为10%，则图中近3天增长人数为1万人".format(
                account7, account5, account3),
            pos_top="4%",
            pos_left="20%"
        ),
        tooltip_opts=opts.TooltipOpts(
    ...
    .render("D:/Pchong/data_see/html_all/Georgia州近七天感染状况.html"))
""""""
