...
US=pd.read_csv(name,usecols=[0,1,2,11,16,15])    #如有报错可能是路径的问题
print(US)
...
# ).render("test1.html")
).render("D:\Pchong\data_see\html_all\Pos_log.html")
)
...
# ).render("test1.html")
).render("D:\Pchong\data_see\html_all\Pos_value.html")
)
...
Combine_REC=(
    ...
    .set_global_opts(
        title_opts=opts.TitleOpts(title="Recovered_situation", pos_left="35%",pos_top="50%",),
        tooltip_opts=opts.TooltipOpts(trigger="axis", axis_pointer_type="cross"),
        legend_opts=opts.LegendOpts(pos_left="68%",pos_top="50%"),
        datazoom_opts=[
        opts.DataZoomOpts(range_start=0, range_end=100,pos_bottom="49%",xaxis_index=0,type_="inside"),],
        xaxis_opts=opts.AxisOpts(type_="category"),
        yaxis_opts=opts.AxisOpts(
...
grid = (
    ...
    .add(Combine_Pos_log, grid_opts=opts.GridOpts(pos_right="55%",pos_bottom="55%"), is_control_axis_index=True)
    .add(Combine_DEA, grid_opts=opts.GridOpts(pos_left="55%",pos_bottom="55%"), is_control_axis_index=True)
    .add(Combine_REC, grid_opts=opts.GridOpts(pos_top="57%"), is_control_axis_index=True)
...
Death=(
    ...
    # ).render("test1.html")
).render("D:\Pchong\data_see\html_all\death.html")
)
...
Recovered=(
    ...
    .set_global_opts(
        title_opts=opts.TitleOpts(title="Recovered_situation", pos_left="45%",pos_top="top",),
        tooltip_opts=opts.TooltipOpts(trigger="axis"),
        legend_opts=opts.LegendOpts(pos_left="68%",pos_top="top"),
        datazoom_opts=[
        opts.DataZoomOpts(range_start=0, range_end=100,pos_bottom="49%",xaxis_index=0,type_="inside"),],
    ...
    # ).render("test1.html")
).render("D:\Pchong\data_see\html_all\Recovered.html")
)
print(recovered_all)
