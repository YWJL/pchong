...
def Pos_log_line(DATE,positive_all,new_case):
...
def Pos_value_line(DATE,positive_all,new_case):
...
grid = (
    ...
    .add(Combine_pos_value, grid_opts=opts.GridOpts(pos_right="55%",pos_bottom="55%"), is_control_axis_index=True)
...
if __name__ == '__main__':
    Pos_value_line(DATE,positive_all,new_case)
    Pos_log_line(DATE,positive_all,new_case)
...
Death=(
    ...
    # ).render("test1.html")
).render("D:\Pchong\data_see\daily\death.html")
)
...
Recovered=(
    ...
    # ).render("test1.html")
).render("D:\Pchong\data_see\daily\Recovered.html")
