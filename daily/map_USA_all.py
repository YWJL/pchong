...
with open('D:/Pchong/data_see/daily/USA.json', 'r') as f:
    data = json.loads(f.read())
path = 'D:/Pchong/data_see/data/20200628-data'
os.chdir(path)
Pos_name = '2020-06-27-1point3acres-us_state-confirmed-data.json.csv'
Dea_name = '2020-06-27-1point3acres-us_state-death-data.json.csv'
...
for i in range(1, count):
    if US_Pos.columns.values[i] != 'US':
        country.append(US_Pos.columns.values[i])
...
(
    ...
    .render("D:/Pchong/data_see/html_all/USA-27200621.html")
)
