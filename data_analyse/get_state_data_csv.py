...
state_csv='D:/Pchong/data_see/data_all/20200603-data.json.csv'
state_json='D:/Pchong/data_see/data_all/20200603-data.json'
def write_list_to_json(list, json_file_name, json_file_save_path):
    os.chdir(json_file_save_path)
    with open(json_file_name, 'w') as  f:
        json.dump(list, f)

url = 'https://coronavirus.1point3acres.com/_next/static/chunks/662779bc929ddd8b2b9837c6c01da5245ffe136a.ed32c1a0449622f0b960.js'
headers = {
