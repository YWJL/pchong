...
name='D:/Pchong/可视化/data_all/daily.csv'
US=pd.read_csv(name)
# Population=pd.read_csv('USA_population.csv')
...
(
    ...
    .render("D:/Pchong/可视化/html_all/USA-5-23.html")
)
...
(
    ...
    .render("D:/Pchong/可视化/html_all/USA-week.html")
)
print(ACCOUNT_REC)