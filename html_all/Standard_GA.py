...
name='D:/Pchong/可视化/data_all/20200523-data.json.csv'
...
for i in range(1,144):
    ...
    for j in range(0,len(data)):
        if DATA.iloc[i + 390, 2] ==data.iloc[j,0]:
...
(
    ...
    .render("D:/Pchong/可视化/html_all/Standard-GA-100,000.html")
)
print('Standard_data:',Standard_data)

print(DATA.iloc[2420,2])
print(number_cou)