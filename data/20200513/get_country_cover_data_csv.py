...
write_list_to_json(data_relative_confirmed_json,'202005013-world-cover-data.json','E:/python_code/world_cov19')
data_csv=pd.DataFrame(json.loads(open('202005013-world-cover-data.json','r+').read()))
print(end_1[36][0])
...
data_csv.T
data_csv.to_csv('202005013-world-cover-data.json.csv')
df=pd.read_csv('202005013-world-cover-data.json.csv')
new_csv=df.T
new_csv.to_csv('202005013-world-cover-data.json.csv')