...
def get_us_state_data(url_us_state,headers,data,date,data_class,csv_date):
    ...
    for i in range(14,len(end_1)):
        ...
        write_list_to_json(data_relative_confirmed_json, '20200602.json')
        data_csv = pd.DataFrame(json.loads(open('20200602.json', 'r+').read()))
...
def csv_dropline(filename):
    ...
    data_new=data.drop([0]) #删除0行数据
    data_new.to_csv(filename,index=0)
######################################################################
url_us_state = 'https://coronavirus.1point3acres.com/_next/static/chunks/3420082b83775474ac41c9121de1970559e0f341.771227c3483b07d98839.js'

url_world = 'https://coronavirus.1point3acres.com/_next/static/chunks/d6285cea722d368218fca8296a0df478e384fb6d.4ffa209b46257198ea57.js'
...
csv_dropline(csv_date+'-1point3acres-us_state-confirmed-data.json.csv')
csv_dropline(csv_date+'-1point3acres-us_state-death-data.json.csv')
csv_dropline(csv_date+'-1point3acres-world-confirm-data.json.csv')
csv_dropline(csv_date+'-1point3acres-world-death-data.json.csv')