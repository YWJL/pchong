...
name1 = '2020-06-19-1point3acres-us_state-confirmed-data.json.csv'
name2 = '2020-06-19-1point3acres-us_state-death-data.json.csv'
name3 = '20200619-world-confirm-data.json.csv'
